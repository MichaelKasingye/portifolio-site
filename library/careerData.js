...
export const intro ={
    name: "Software Developer, Coding Instructor",
...
export const skills ={
        ...
        roles:[
            {
                Title:"Leadership",
            description:"Good leadership skills; 1 year experience leading teams of 5-15 people"
        },
            {
                Title:"Software",
                description:"1.5 years software experience developing web applications"
        },
        ],
        tech:"Technologies",
        tools:[
            {
                heading:"Languages",
            description:"JavaScript, HTML, CSS, Java, Express JS, React JS, Material UI, Bootstrap "
        },
        {
            heading:"Tools",
